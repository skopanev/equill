...
/// because the contents are the secret.
#[test]
fn a_missing_key_file_fails_without_quoting_anything() {
    let missing = PathBuf::from("/nonexistent/equill/voyage/token");
